...
const HubOrderItem = ({ order, users, index }) => {
  ...
  const [orderVerifyStatus, { isLoading: verifyLoading }] =
    useOrderVerifyStatusMutation();
  ...
  return (
    <div className='flex flex-col md:flex-row justify-between gap-4 py-4 border-b border-gray-500 lg:items-center '>
      {(showLoader || isLoading || deleteLoading || verifyLoading) && <Loader />}
      ...
      <p className='flex-[.75]'>
        <span className='inline-block md:hidden'>Type : </span> {order.orderType}
      </p>
      ...
      <div
        ref={dialogRef}
        className='flex-[.75] flex justify-start md:justify-end relative items-center'
      >
        ...
        {showActions && (
          <div className='action_links_wrap z-30 absolute right-20 md:right-10 -top-24 md:top-0  w-[200px] rounded bg-gray-500 py-4'>
            <ul>
              <Link
                to={`/order/${order._id}`}
                className='border-b border-gray-700 py-2 px-4 text-center block'
              >
                View Details
              </Link>
              ...
              {order.orderStatus == 'Delivered' ? (
                <li className='block border-b border-gray-700 py-2 px-4 text-center cursor-not-allowed'>
                  Already Delivered
                </li>
              ) : (
                <li
                  onClick={showDeliveredHandler}
                  className='block border-b border-gray-700 py-2 px-4 text-center cursor-pointer'
                >
                  Mark as Delivered
                </li>
              ...
              {order.orderStatus == 'Offline Delivery' ? (
                <li className='block border-b border-gray-700 py-2 px-4 text-center cursor-not-allowed'>
                  Already Offline Delivery
                </li>
              ) : (
                <li
                  onClick={showOfflineHandler}
                  className='block border-b border-gray-700 py-2 px-4 text-center cursor-pointer'
                >
                  Offline Delivery
                </li>
              ...
              <li
                onClick={() => verifiedHandler('Verified')}
                className='block border-b border-gray-700 py-2 px-4 text-center cursor-pointer'
              >
                Mark as Verified
              </li>
              ...
              <li
                onClick={() => verifiedHandler('Not Found')}
                className='block border-b border-gray-700 py-2 px-4 text-center cursor-pointer'
              >
                Mark as NOT Found
              </li>
          ...
          <div className='flex justify-center items-center'>
            <div className='modal_inner w-3xl max-w-[90%] bg-green-600 text-white relative p-10 rounded'>
              <img
                ...
                className='absolute w-12 cursor-pointer -top-14 right-0'
                src={Close}
                alt=''
              />

              <h2 className='text-green text-xl mb-6'>
                Do you want to make this order as "Delivered"? Select rider first.
              </h2>

              <div className='form_row flex flex-col gap-2 mb-6'>
                <label htmlFor=''>Select Rider:</label>
                <select
                  className='border rounded border-gray-300 text-white bg-green-700 h-11 flex items-center px-4'
                  value={selectedRider}
              ...
              <div className='cta_wrap flex gap-6 my-6'>
                <button
                  ...
                  className='cursor-pointer bg-black p-4 rounded '
                >
          ...
          <div className='flex justify-center items-center'>
            <div className='modal_inner w-3xl max-w-[90%] bg-yellow-600 text-white relative p-10 rounded'>
              ...
              <h2 className='text-green text-xl'>
                Do you want to make this order as "Cancelled"? Be careful, you can't
                undo this action.
              </h2>
              <div className='cta_wrap flex gap-6 my-6'>
                <button
        ...
        <div className='modal fixed top-0 left-0 w-screen h-screen z-20 backdrop-blur-xs block pt-20 lg:pt-[150px] pb-24 overflow-auto'>
          <div className='flex justify-center items-center'>
            <div className='modal_inner w-3xl max-w-[90%] bg-yellow-600 text-white relative p-10 rounded'>
              ...
              />
              <h2 className='text-green text-xl mb-6'>
                Do you want to make this order as "Offline Delivery"? Select rider
                first.
              </h2>
              ...
              <div className='form_row flex flex-col gap-2 mb-6'>
                <label htmlFor=''>Select Rider:</label>
                <select
                  className='border rounded border-gray-300 text-white bg-yellow-700 h-11 flex items-center px-4'
                  value={selectedRider}
                  onChange={(e) => setSelectedRider(e.target.value)}
                >
                  <option value=''>Select one:</option>
        ...
        <div className='modal fixed top-0 left-0 w-screen h-screen z-20 backdrop-blur-xs block pt-20 lg:pt-[150px] pb-24 overflow-auto'>
          <div className='flex justify-center items-center'>
            <div className='modal_inner w-3xl max-w-[90%] bg-red-600 text-white relative p-10 rounded'>
              ...
              />
              <h2 className='text-green text-xl'>
                Do you want to DELETE this order? Be careful, you can't undo this
                action.
              </h2>
              <div className='cta_wrap flex gap-6 my-6'>
                <button
