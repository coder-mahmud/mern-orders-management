...
import { useCreateInternalReportMutation, useGetInternalReportsByDateQuery } from '../slices/internalReportApiSlice';
...
const InternalReport = () => {
  ...
  const [ createInternalReport,{isLoading:isRiderReportLoading}] = useCreateInternalReportMutation()
  const {data:riderReportData, isLoading:riderReportLoaading} = useGetInternalReportsByDateQuery(dayjs(showDate).format('YYYY-MM-DD'))
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const apiRes = await createInternalReport(reportData).unwrap();
      console.log("ApiRes", apiRes)
      toast.success("Internal Report created successfully!")
  ...
  console.log("Internal Report Data:",riderReportData)
    ...
    <div className='bg-gray-800 text-white min-h-[95vh] py-14'>
      <div className="container">
        ...
        <div className="flex justify-between items-center">
          <h1 className='text-3xl'>Internal Reports!</h1>
        ...
        <div className="date my-6">
         ...
         {riderReportData.reports.map(report => <li className='border-b pb-4 mb-4 list-none ' key={report._id}>
          ...
          <div className="flex gap-4">
            ...
            <p className="t">Rider: {report.rider}</p>
          </div>
                  ...
                  <div className="modal_inner w-3xl max-w-[90%] bg-gray-600 text-white relative p-10 rounded">
                    ...
                    <div className=''>
                      ...
                      <div className="form_row flex flex-col gap-2 mb-6">
                        ...
                        <select className='border rounded border-gray-500 h-11 flex items-center px-4 ' name="" id="" value={rider} onChange = {(e) => setRider(e.target.value)}>
                          <option value="">Select one:</option>
                          <option value="Abdur rahim">Abdur rahim</option>
                          <option value="Mr. Aslam">Mr. Aslam</option>
                          <option value="Ridoy Khan Emon">Ridoy Khan Emon</option>
                          <option value="Mr. Zaman">Mr. Zaman</option>
                          <option value="Mr. Rashed">Mr. Rashed</option>
                          <option value="Ornob Hasan">Ornob Hasan</option>
                      ...
                      <div className="date my-6 flex gap-4 flex-col md:flex-row justify-between md:items-center">
                        <div className="flex flex-col sm:flex-row gap-1 md:items-center mb-6">
                      ...
                      <div className="number flex justify-between items-center mb-6">
                        ...
                        <div className="online">
                          <p className="mb-1">Number of Orders</p>
                          <div className="flex gap-4">
